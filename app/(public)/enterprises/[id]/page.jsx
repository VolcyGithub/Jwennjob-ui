...
const companies = [
  {
    ...
    founded: "2020",
    description: "PayAyiti révolutionne les paiements mobiles en Haïti en offrant une solution innovante qui fonctionne sans connexion internet, facilitant ainsi les transactions pour tous.",
    employees: "25-50",
  ...
  },
  {
    ...
    description: "Kolabo permet aux voisins de louer des outils et équipements entre eux.",
    employees: "10-25",
    location: "Delmas",
    founded: "2021",
  ...
  },
  {
    ...
    description: "SunBox fournit des kits solaires abordables pour les zones rurales.",
    employees: "50-100",
    location: "Carrefour",
    founded: "2018",
  },
  {
    ...
    description: "JwennNews offre une couverture médiatique en temps réel des événements locaux et internationaux.",
    employees: "5-10",
    location: "Pétion-Ville",
    founded: "2022",
  },
        ...
        <div className="grid lg:grid-cols-12 gap-10">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-start gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-2">
                   <h1 className="text-3xl font-black text-third">{company.name}</h1>
                    <MdVerified className="text-secondary" size={24} />
                  </div>
                  <p className="text-gray-500 font-medium">{company.sector}</p>
                </div>
              </div>
            </div>
            
            <EnterpriseTabs company={company} />
          </div>
          ...
          <aside className="lg:col-span-4 space-y-6 sticky top-40 h-fit">
            <div className="bg-primary rounded-4xl p-8 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] uppercase text-gray-400 font-bold tracking-widest">Effectif</p>
                    <p className="text-sm font-bold">{company.employees}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-white/10 rounded-4xl text-secondary">
                  ...
                  <div>
                    <p className="text-[10px] uppercase text-gray-400 font-bold tracking-widest">Fondation</p>
                    <p className="text-sm font-bold">{company.founded}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-white/10 rounded-4xl text-secondary">
                  ...
                  <div>
                    <p className="text-[10px] uppercase text-gray-400 font-bold tracking-widest">Siège Social</p>
            ...
            <div className="bg-white/50 rounded-4xl p-8">
              <h3 className="font-black text-lg mb-6 text-primary">Social & Web</h3>
