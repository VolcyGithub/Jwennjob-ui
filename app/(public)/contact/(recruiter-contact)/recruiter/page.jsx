...
export default function BecomeRecruiterPage() {
  ...
  return (
    <main className="bg-third pt-2 pb-20 font-sans text-gray-900">
      <div className="mx-auto px-1 md:px-6">
        <div className="flex max-md:flex-col items-center justify-center m-2 rounded-4xl p-4 md:px-16 bg-primary text-white min-h-[70vh] lg:min-h-[80vh] overflow-hidden">
          <div className="flex items-center max-w-3xl justify-center">
            <div className="mt-[100px]">
              <h1 className="text-2xl md:text-6xl text-center md:text-start font-medium max-w-4xl leading-tight">
                Un recrutement réussi commence par une connexion intelligente.
              </h1>
              <p className="mt-8 text-gray-300 max-w-xl text-center md:text-start text-lg">
                Notre plateforme vous aide à attirer, identifier et recruter les
                meilleurs profils en Haïti, ceux qui s’épanouiront vraiment au
                sein de vos équipes.
              </p>
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black text-primary mb-6">
            Ils recrutent déjà sur{" "}
            <span className="text-secondary">JwennJob</span>
          </h1>
          <p className="text-gray-500 max-w-sm text-sm  md:max-w-2xl mx-auto">
            Rejoignez des entreprises de toutes tailles et de tous secteurs qui
            transforment leur manière de recruter avec nous.
          </p>
          ...
          <div className="flex-col md:flex md:items-center lg:flex-row gap-8 lg:gap-16 justify-center">
            <div className="block">
              ...
              <p className="text-gray-300 max-md:text-xs max-w-2xl mx-auto mb-8">
                Oubliez la recherche manuelle interminable. Notre outil de
                Sourcing, propulsé par un algorithme de filtrage puissant,
                analyse les compétences et la localisation pour vous présenter
                les candidats qui correspondent exactement à vos critères RH.
              </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-xs text-primary mb-4">
                      Explorez notre data center via des filtres avancés.
                    </p>
        ...
        >
          <h1 className="text-4xl text-center mx-auto md:text-5xl max-w-4xl font-black text-primary mb-6">
            Racontez votre histoire, Attirez les{" "}
            <span className="text-secondary">Talents Parfaits</span>
          </h1>
          <p className="text-gray-500 text-center max-w-sm text-sm  md:max-w-2xl mx-auto">
            Votre page entreprise sur Jwennjob est bien plus qu'une simple
            présentation. C'est une immersion dans votre culture. Valorisez vos
            missions, vos photos et vos témoignages d'équipe pour convaincre les
            talents faits pour vous de postuler.
          </p>
          ...
          <div className="relative mx-auto max-w-5xl 2xl:max-w-screen-2xl px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
              ...
              <div className="md:col-span-1">
                ...
                />
                <h3 className="text-[24px]/7.5 font-bold mt-6 text-primary">
                  Et si c'était votre tour ?
                </h3>
                <p className="text-gray-600 mt-2">
                  Augmentez votre attractivité et recrutez avec précision dès
                  aujourd'hui.
                </p>
                <Link
                  href="/contact/become-recruiter"
                  className="group flex items-center gap-2 mt-4 text-secondary transition font-bold hover:text-secondary/80"
                >
                  Demander une démo
                  <svg
