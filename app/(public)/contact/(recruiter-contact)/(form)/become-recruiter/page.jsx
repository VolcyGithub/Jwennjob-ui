...
const InputField = ({ label, icon, error, ...props }) => (
  <div className="w-full mb-4">
    <label className="block text-xs font-bold text-primary mb-1.5 ml-1 uppercase tracking-tight">
      {label}
    </label>
...
export default function EmployerRequestPage() {
  ...
  return (
    <div className="flex mb-[100px] flex-col lg:flex-row min-h-screen w-full font-sans">
      {/* GAUCHE : Grand Texte & Copywriting */}
      <div className="w-full p-3 lg:w-1/2">
        <div className="bg-primary rounded-4xl h-full w-full max-md:pt-30 p-10  lg:p-20 flex flex-col justify-center text-white">
          <h1 className="text-5xl lg:text-7xl font-black leading-[1.1] mb-8">
            Recrutez les <span className="text-secondary">meilleurs</span>{" "}
            talents de demain.
          </h1>

          <p className="text-md md:text-xl text-gray-300 mb-10 max-w-lg leading-relaxed">
            Vous souhaitez en savoir plus sur nos produits et sur comment
            transformer l'expérience que vous proposez à vos candidats et
            employés ? Laissez nous vos coordonnées pour participer à une demo
            produit !
          </p>

          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-secondary text-2xl">
                ✓
              </div>
              <p className="text-sm md:text-lg font-medium">
                Accès au Data Center de talents
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-secondary text-2xl">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-6 lg:pt-30">
        <form
          onSubmit={handleSubmit}
          className="w-full bg-white p-8 lg:p-10 rounded-3xl shadow-2xl shadow-gray-200/50"
        >
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Nos équipes reviendront vers vous après vérification de vos
              pièces.
            </p>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
              ...
              <InputField
                ...
                icon={<BiBriefcase className="text-gray-400" />}
                required
              />
              <InputField
          ...
          <div className="mb-10">
            ...
            <InputField
              ...
              icon={<BiBuildings className="text-gray-400" />}
              required
            />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
              <InputField
                ...
                icon={<BiMap className="text-gray-400" />}
                required
              />
              <InputField
                label="Site Web"
                placeholder="https://www.site.com"
                icon={<BiGlobe className="text-gray-400" />}
              />
            </div>

            <div className="mt-2">
              <label className="block text-xs font-bold text-primary mb-1.5 ml-1 uppercase">
            ...
            <div className="mt-4">
              ...
              <textarea
                className="w-full border border-gray-200 rounded-xl p-4 text-sm outline-none focus:border-primary min-h-[80px]"
                placeholder="Parlez-nous de vos activités..."
              ></textarea>
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <span className="text-[10px] text-center font-bold text-gray-500">
                  Logo Entreprise
                  <br />
                  <span className="font-normal">PNG ou JPG (max 2Mo)</span>
                </span>
              </div>
              <div className="p-4 border border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-gray-50 transition-colors cursor-pointer">
          ...
          <div className="mt-8">
            <label className="flex items-start gap-3 cursor-pointer mb-6">
              ...
              <span className="text-[11px] text-gray-500 leading-tight">
                Je certifie que les informations fournies sont exactes et que je
                suis autorisé à représenter cette entreprise sur la plateforme{" "}
                <strong>JwennJob</strong>.
              </span>
            </label>
