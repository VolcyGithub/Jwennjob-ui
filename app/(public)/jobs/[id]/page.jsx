...
export default function JobDetailPage({ params }) {
  ...
  if (!details) return <div className="min-h-[80vh] flex items-center justify-center"><p className="p-10 text-center">Offre introuvable</p></div>;
  ...
  return (
    <main className="bg-[#fdfdfd] min-h-screen pb-100 font-sans text-gray-900 ">
      <div className="absolute top-0 left-0 w-full h-[400px] 2xl:h-[500px] overflow-hidden">
        <Image src={`https://jwennjob.com/${job.recruiter.banner}`} alt="banner" width={200} height={400} className="w-full max-h-[500px] object-cover" />
      </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 p-1 bg-white">
                      <Image src={job.recruiter.photo} alt="logo" width={48} height={48} className="object-contain rounded-md" />
                    </div>
                  ...
                  <div className="gap-y-4 text-sm">
                    ...
                    <div className="flex flex-1 md:space-x-12 space-y-8 mb-6 flex-wrap md:flex-nowrap items-center">
                      <div className="space-y-3">
                        ...
                        <p className="flex items-center gap-2 text-gray-500 font-medium"><IoBriefcase className="text-gray-400" /> {job.sector}</p>
                        <p className="flex items-center gap-2 text-gray-500 font-medium"><IoLocation className="text-gray-400" /> {job.recruiter.adresse}</p>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="flex items-center gap-2 text-gray-500 font-medium"><IoCash className="text-gray-400" /> {job.salary || "Indéfini"}</p>
            ...
            <div className="bg-[#f8f8f8] rounded-4xl p-8 mb-8">
              ...
              <div className="space-y-10">
                <section>
                  ...
                  <p className="text-gray-700 space-y-3 leading-relaxed whitespace-pre-line" dangerouslySetInnerHTML={{ __html: job.description }}></p>
                </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[1, 2].map((v) => (
                  <div key={v} className="group relative aspect-video rounded-4xl overflow-hidden cursor-pointer">
                    <Image src={`https://jwennjob.com/${job.recruiter.banner}`} alt="Video thumb" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
          ...
          <aside className="lg:col-span-4 space-y-6 sticky top-40 h-fit">
            ...
            <div className="bg-white rounded-4xl overflow-hidden shadow-sm border border-gray-100">
              <div className="relative h-41">
                <Image src={`https://jwennjob.com/${job.recruiter.banner}`} alt={job.recruiter.nom} fill className="object-cover" />
              </div>
            ...
            <div className="bg-white rounded-4xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="flex items-center gap-3 mb-6">
                <Image src={job.recruiter.photo} alt="logo" width={40} height={40} className="rounded" />
