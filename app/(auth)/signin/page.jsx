...
const Separator = () => (
  <div className="flex items-center gap-4 w-full my-5">
    ...
    <p className="text-nowrap text-sm text-gray-500/90">ou se connecter avec un e-mail</p>
    <div className="w-full h-px bg-gray-300/90" />
  </div>
);
      ...
      <div className="w-full md:h-screen flex flex-col items-center justify-center pt-12 px-4">
        ...
        <form onSubmit={handleSubmit} className="md:w-96 w-full max-w-sm flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500/90 mt-3 text-center">
            <span className="text-secondary font-semibold">Bienvenue !</span> Connectez-vous pour continuer
          </p>
          ...
          <div className="w-full flex items-center justify-between mt-8 text-gray-500/80">
            ...
            <Link href="/forgot-password" className="text-sm underline hover:text-primary transition-colors">
              Mot de passe oublié ?
            </Link>
          </div>
